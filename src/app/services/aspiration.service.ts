...
export class AspirationService {
  baseUrl = 'https://localhost:44396/api/Aspiration';
  ...
  public getAll() {
    return this.http.post(`${this.baseUrl}/Get`, null, { withCredentials: true,});
  }
  ...
  public create(element: any) {
    return this.http.post(`${this.baseUrl}/Create`, element, {withCredentials: true, });
  }
